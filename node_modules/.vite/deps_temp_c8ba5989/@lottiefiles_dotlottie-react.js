...
var g = (c, n, i) => new Promise((s, d) => {
  ...
  }, M = (P) => P.done ? s(P.value) : Promise.resolve(P.value).then(m3, b);
...
var r0 = (() => {
  ...
  return function(i = {}) {
    var s, d = i, m3, b, M = new Promise((e, t) => {
      m3 = e, b = t;
    ...
    function X1(e, t, r, a, o) {
      ...
      return _1(e, function(...U4) {
        ...
        for (var T = 0; T < v; ++T) f[T] = t[T + 2].toWireType(L, U4[T]), w.push(f[T]);
        if (U4 = a(...w), l) V1(L);
        else for (T = h ? 1 : 2; T < t.length; T++) {
          var N4 = T === 1 ? I : f[T - 2];
          t[T].Da !== null && t[T].Da(N4);
        }
    ...
    var B2 = (e) => {
      ...
      if (r <<= 1, 32 < r - e && H2) return H2.decode(x.subarray(e, r));
      for (r = "", a = 0; !(a >= t / 2); ++a) {
        var o = a1[e + 2 * a >> 1];
        if (o == 0) break;
    ...
    var V3 = { c: (e, t, r, a) => P1(`Assertion failed: ${e ? c1(x, e) : ""}, at: ` + [t ? t ? c1(x, t) : "" : "unknown filename", r, a ? a ? c1(x, a) : "" : "unknown function"]), m: (e, t, r) => {
      ...
      Q([e], u, (h) => {
        ...
        return o.forEach((p, v) => {
          var f = h[v], w = p.Ya, L = p.Za, U4 = h[v + o.length], I = p.fb, T = p.hb;
          l[p.Va] = { read: (N4) => f.fromWireType(w(L, N4)), write: (N4, w1) => {
            var B = [];
            I(T, N4, U4.toWireType(B, w1)), V1(B);
          } };
      ...
      q1(U4, function() {
        ...
        if (I = I[0], a) var T = I.va, N4 = T.Ga;
        else N4 = x1.prototype;
        I = _1(f, function(...d2) {
        ...
        return T = new g1(f, B, true, false, false), b1 = new g1(f + "*", B, false, false, false), N4 = new g1(f + " const*", B, false, true, false), O2[e] = { pointerType: b1, Ta: N4 }, W2(U4, I), [T, b1, N4];
      });
    }, q: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      o = z(a, o), Q([], [e], (l) => {
      ...
      t = D(t), t = B2(t), u = z(o, u), Q([], [e], (v) => {
        ...
        var L = v.va.Ga, U4 = L[t];
        return U4 === void 0 || U4.ya === void 0 && U4.className !== v.name && U4.Ha === r - 2 ? (f.Ha = r - 2, f.className = v.name, L[t] = f) : (z2(L, t, w), L[t].ya[r - 2] = f), Q([], p, (I) => (I = X1(w, I, v, u, h), L[t].ya === void 0 ? (I.Ha = r - 2, L[t] = I) : L[t].ya[r - 2] = I, [])), [];
      });
      ...
      H(e, { name: t, fromWireType: function(a) {
        ...
        if (r) for (var h = u, l = 0; l <= o; ++l) {
          var p = u + l;
          if (l == o || x[p] == 0) {
            if (h = h ? c1(x, h, p - h) : "", v === void 0) var v = h;
            else v += "\0", v += h;
            h = p + 1;
          }
        }
        ...
        if (l = s2(4 + u + 1), p = l + 4, E[l >> 2] = u, r && h) p1(o, p, u + 1);
        else if (h) for (h = 0; h < u; ++h) {
          var v = o.charCodeAt(h);
          if (255 < v) throw X(p), new y("String has UTF-16 code units that do not fit in 8 bits");
          x[p + h] = v;
        }
        else for (h = 0; h < u; ++h) x[p + h] = o[h];
    ...
    function X2() {
      function e() {
        ...
        if (!D1 && (D1 = true, d.calledRun = true, !E1)) {
          if (H1(E2), m3(d), (r = d.onRuntimeInitialized) == null || r.call(d), d.postRun) for (typeof d.postRun == "function" && (d.postRun = [d.postRun]); d.postRun.length; ) {
  ...
  static _initializeObserver() {
    ...
    let n = (i) => {
      i.forEach((s) => {
        ...
        this._observedCanvases.set(s.target, [m3, M]);
      });
    };
...
var C = class C2 {
  constructor(n) {
    ...
    var i, s, d;
    this._canvas = n.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new s1(), this._frameManager = new z1(), this._renderConfig = k(F({}, n.renderConfig), { devicePixelRatio: ((i = n.renderConfig) == null ? void 0 : i.devicePixelRatio) || Z(), freezeOnOffscreen: (d = (s = n.renderConfig) == null ? void 0 : s.freezeOnOffscreen) != null ? d : true }), i1.load().then((m3) => {
      var b, M, P, R, O, d1, L1, K;
      C2._wasmModule = m3, this._dotLottieCore = new m3.DotLottiePlayer({ themeId: (b = n.themeId) != null ? b : "", autoplay: (M = n.autoplay) != null ? M : false, backgroundColor: 0, loopAnimation: (P = n.loop) != null ? P : false, mode: m2((R = n.mode) != null ? R : "forward", m3), segment: y2((O = n.segment) != null ? O : [], m3), speed: (d1 = n.speed) != null ? d1 : 1, useFrameInterpolation: (L1 = n.useFrameInterpolation) != null ? L1 : true, marker: (K = n.marker) != null ? K : "", layout: n.layout ? { align: g2(n.layout.align, m3), fit: _2(n.layout.fit, m3) } : m3.createDefaultLayout() }), this._eventManager.dispatch({ type: "ready" }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), n.backgroundColor && this.setBackgroundColor(n.backgroundColor);
    }).catch((m3) => {
      this._eventManager.dispatch({ type: "loadError", error: new Error(`Failed to load wasm module: ${m3}`) });
    ...
    if (n) return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
      ...
      switch (n.fit) {
        ...
        case ((d = C2._wasmModule) == null ? void 0 : d.Fit.Cover):
          return "cover";
        case ((m3 = C2._wasmModule) == null ? void 0 : m3.Fit.Fill):
          return "fill";
  ...
  get mode() {
    ...
    return n === ((s = C2._wasmModule) == null ? void 0 : s.Mode.Reverse) ? "reverse" : n === ((d = C2._wasmModule) == null ? void 0 : d.Mode.Bounce) ? "bounce" : n === ((m3 = C2._wasmModule) == null ? void 0 : m3.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  setRenderConfig(n) {
    let m3 = n, { devicePixelRatio: i, freezeOnOffscreen: s } = m3, d = O1(m3, ["devicePixelRatio", "freezeOnOffscreen"]);
  ...
  markers() {
    ...
    if (n) {
      ...
      for (let d = 0; d < n.size(); d += 1) {
        let m3 = n.get(d);
        s.push({ name: m3.name, time: m3.time, duration: m3.duration });
      }
      return s;
    }
    return [];
  ...
  _getPointerPosition(n) {
    let i = this._canvas.getBoundingClientRect(), s = this._canvas.width / i.width, d = this._canvas.height / i.height, m3 = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, b = (n.clientX - i.left) * s / m3, M = (n.clientY - i.top) * d / m3;
    return { x: b, y: M };
  }
  _onPointerUp(n) {
  ...
  animationSize() {
    var s, d, m3, b;
    let n = (d = (s = this._dotLottieCore) == null ? void 0 : s.animationSize().get(0)) != null ? d : 0, i = (b = (m3 = this._dotLottieCore) == null ? void 0 : m3.animationSize().get(1)) != null ? b : 0;
  ...
  getLayerBoundingBox(n) {
    ...
    let s = i.get(0), d = i.get(1), m3 = i.get(2), b = i.get(3);
    return { x: s, y: d, width: m3, height: b };
  }
...
var q = class q2 {
  constructor(n) {
    ...
    this._worker = q2._workerManager.getWorker(i), q2._workerManager.assignAnimationToWorker(this._id, i), q2._wasmUrl && this._sendMessage("setWasmUrl", { url: q2._wasmUrl }), this._create(k(F({}, n), { renderConfig: k(F({}, n.renderConfig), { devicePixelRatio: ((s = n.renderConfig) == null ? void 0 : s.devicePixelRatio) || Z(), freezeOnOffscreen: (m3 = (d = n.renderConfig) == null ? void 0 : d.freezeOnOffscreen) != null ? m3 : true }) })), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this)), this._pointerUpMethod = this._onPointerUp.bind(this), this._pointerDownMethod = this._onPointerDown.bind(this), this._pointerMoveMethod = this._onPointerMove.bind(this), this._pointerEnterMethod = this._onPointerEnter.bind(this), this._pointerExitMethod = this._onPointerLeave.bind(this);
  }
  ...
  _sendMessage(n, i, s) {
    return g(this, null, function* () {
      ...
      return this._worker.postMessage(d, s || []), new Promise((m3, b) => {
        let M = (P) => {
          let R = P.data;
          R.id === d.id && (this._worker.removeEventListener("message", M), R.error ? b(new Error(`Failed to execute method ${n}: ${R.error}`)) : m3(R.result));
        };
  ...
  _getPointerPosition(n) {
    let i = this._canvas.getBoundingClientRect(), s = this._canvas.width / i.width, d = this._canvas.height / i.height, m3 = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, b = (n.clientX - i.left) * s / m3, M = (n.clientY - i.top) * d / m3;
    return { x: b, y: M };
  }
  _onPointerUp(n) {
    let { x: i, y: s } = this._getPointerPosition(n);
...
var m = ({ animationId: o, autoplay: E, backgroundColor: D, className: W2, createDotLottie: S, data: c, dotLottieRefCallback: b, layout: n, loop: d, mode: g3, playOnHover: w, renderConfig: k2, segment: s, speed: y, src: a, style: h, themeData: P, themeId: l, useFrameInterpolation: R, workerId: O, ...v }) => {
  let [r, C3] = (0, import_react.useState)(null), f = (0, import_react.useRef)(null), t = (0, import_react.useRef)(null), T = (0, import_react.useRef)(b), x = { speed: y, mode: g3, loop: d, useFrameInterpolation: R, segment: s, backgroundColor: D, autoplay: E, themeId: l, workerId: O, src: a, data: c, layout: n, renderConfig: k2 }, u = (0, import_react.useRef)(x);
  T.current = b, t.current = r, u.current = x, (0, import_react.useEffect)(() => {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    var _a;
    (_a = t.current) == null ? void 0 : _a.setBackgroundColor(D ?? "");
  }, [D]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = t.current) == null ? void 0 : _a.setRenderConfig(k2 ?? {});
  }, [JSON.stringify(k2)]), (0, import_react.useEffect)(() => {
    var _a;
