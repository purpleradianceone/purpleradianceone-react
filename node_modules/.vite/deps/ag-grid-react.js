...
var PopupEditorComp = (props) => {
  ...
  const { context, popupSvc, localeSvc, gos, editSvc } = (0, import_react21.useContext)(BeansContext);
  useEffectOnce(() => {
    var _a2, _b;
...
var CellComp = ({
  ...
  const renderCell = () => import_react20.default.createElement("div", { ref: setGuiRef, style: userStyles, role: cellAriaRole, "col-id": colIdSanitised, onBlur }, showCellWrapper ? import_react20.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents());
