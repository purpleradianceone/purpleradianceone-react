...
function M(n2, r2, t2) {
  if (y(r2)) return r2;
  var e = r2[Q];
  if (!e) return i(r2, function(i2, o4) {
...
function R(e) {
  return r(e) || n(22, e), function n2(r2) {
    ...
    if (u3) {
      if (!u3.P && (u3.i < 4 || !b("ES5").K(u3))) return u3.t;
    ...
    switch (n2.i) {
      ...
      case 1:
        return function(n3, r3, t3, e3) {
          ...
          for (var v2 = 0; v2 < i2.length; v2++) if (o3[v2] && u3[v2] !== i2[v2]) {
            var p3 = r3.concat([v2]);
...
var en = { get: function(n2, r2) {
  ...
  if (!n2.P) {
    ...
    if (o3 && o3.t === t2) return n2.o[r2] = t2, n2.R[r2] = false, true;
    ...
    this.O = B, this.D = true, this.produce = function(r3, i3, o3) {
      if ("function" == typeof r3 && "function" != typeof i3) {
        ...
        return function(n2) {
          var r4 = this;
          void 0 === n2 && (n2 = u3);
          for (var t2 = arguments.length, e3 = Array(t2 > 1 ? t2 - 1 : 0), o4 = 1; o4 < t2; o4++) e3[o4 - 1] = arguments[o4];
      ...
      if ("function" == typeof n2) return function(r4) {
        for (var t3 = arguments.length, i4 = Array(t3 > 1 ? t3 - 1 : 0), o4 = 1; o4 < t3; o4++) i4[o4 - 1] = arguments[o4];
    ...
    if (null != n2) {
      ...
      try {
        if (o3 = (n2 = n2.call(e2)).next, 0 === t3) {
          ...
          s3 = false;
        } else for (; !(s3 = (r2 = o3.call(n2)).done) && (c3.push(r2.value), c3.length !== t3); s3 = true) ;
      } catch (e3) {
        u3 = true, i2 = e3;
      } finally {
        try {
          if (!s3 && null != n2.return && (a3 = n2.return(), Object(a3) !== a3)) return;
        } finally {
          if (u3) throw i2;
        }
      }
...
function Z2(e) {
  return function(e2) {
    if (Array.isArray(e2)) return re(e2);
...
function ne(e, t2) {
  if (e) {
    if ("string" == typeof e) return re(e, t2);
  ...
  return z2(e, [{ key: "add", value: function(e2, t2) {
    ...
    if (0 !== e2.length || 0 !== t2.length) {
      if (this.timeline.length && this.pointer >= 0) {
        ...
        if ((/* @__PURE__ */ new Date()).getTime() - a3 < n2) return void (this.timeline[this.pointer] = { timestamp: a3, patches: [].concat(Z2(i2), Z2(e2)), inversePatches: [].concat(Z2(t2), Z2(o3)) });
      }
      this.add(e2, t2);
    }
  } }, { key: "merge", value: function(e2, t2) {
    if (0 !== e2.length || 0 !== t2.length) if (this.timeline.length && this.pointer >= 0) {
    ...
    if (this.canRedo()) return this.pointer = this.pointer + 1, pn(e2, this.timeline[this.pointer].patches);
  } }]), e;
}();
  ...
  var E3 = (0, import_react.useMemo)(function() {
    ...
    return Y2(Y2({}, e.reduce(function(e2, t4) {
      ...
      return Y2({}, e.filter(function(e2) {
        ...
        return e2[t4] = function() {
          for (var e3 = arguments.length, r3 = new Array(e3), i2 = 0; i2 < e3; i2++) r3[i2] = arguments[i2];
...
var le = function() {
  ...
  return z2(e, [{ key: "subscribe", value: function(e2, t2, n2) {
    ...
    if (this.subscribers.length) {
      ...
      if (t2 > -1) return this.subscribers.splice(t2, 1);
    }
...
var ve = function() {
  ...
  return z2(e, [{ key: "getElementId", value: function(e2) {
    ...
    if (r2) {
      if ((0, import_shallowequal.default)(t2.required, r2.required)) return r2;
  ...
  return z2(e, [{ key: "listen", value: function(e2) {
    ...
    var i2 = function(r3) {
      (function(e3, t3, n3) {
        ...
        for (var r4 = e3.craft && e3.craft.blockedEvents[t3] || [], i3 = 0; i3 < r4.length; i3++) {
          var o3 = r4[i3];
          if (n3 !== o3 && n3.contains(o3)) return true;
        }
        return false;
    ...
    var n2 = [], r2 = e2.handlers(), i2 = new Proxy(r2, { get: function(e3, t3, i3) {
      return t3 in r2 == 0 ? Reflect.get(e3, t3, i3) : function(e4) {
        for (var i4 = arguments.length, o3 = new Array(i4 > 1 ? i4 - 1 : 0), a3 = 1; a3 < i4; a3++) o3[a3 - 1] = arguments[a3];
...
var me = function(e) {
  ...
  var t2, n2, r2 = (t2 = i2, n2 = function() {
    ...
    } else e2 = r3.apply(this, arguments);
...
function we(e) {
  return (t2 = null, ...n2) => {
    ...
    const r2 = t2;
    return function(e2) {
      if ("string" != typeof e2.type) throw new Error();
    }(r2), Ee(r2, e);
  };
}
function Oe(e) {
...
function oe2(e, t2) {
  ...
  var n2, r2, o3 = function(e2, t3) {
    ...
    for (r3 = 0; r3 < a4.length; r3++) t3.indexOf(n3 = a4[r3]) >= 0 || (o4[n3] = e2[n3]);
    return o4;
  }(e, t2);
  if (Object.getOwnPropertySymbols) {
    var a3 = Object.getOwnPropertySymbols(e);
    for (r2 = 0; r2 < a3.length; r2++) t2.indexOf(n2 = a3[r2]) >= 0 || Object.prototype.propertyIsEnumerable.call(e, n2) && (o3[n2] = e[n2]);
  }
  return o3;
}
function ae2(e) {
    ...
    if (null != n2) {
      ...
      try {
        if (a3 = (n2 = n2.call(e2)).next, 0 === t3) {
          if (Object(n2) !== n2) return;
          d3 = false;
        } else for (; !(d3 = (r2 = a3.call(n2)).done) && (s3.push(r2.value), s3.length !== t3); d3 = true) ;
      } catch (e3) {
        c3 = true, o3 = e3;
      } finally {
        try {
          if (!d3 && null != n2.return && (i2 = n2.return(), Object(i2) !== i2)) return;
        } finally {
          if (c3) throw o3;
        }
      }
...
function de2(e) {
  return function(e2) {
    if (Array.isArray(e2)) return ue2(e2);
  }(e) || function(e2) {
...
function ce2(e, t2) {
  if (e) {
    if ("string" == typeof e) return ue2(e, t2);
    var n2 = Object.prototype.toString.call(e).slice(8, -1);
...
function ke({ id: e, children: t2, ...n2 }) {
  const { is: r2 } = { ...Te2, ...n2 }, { query: o3, actions: i2 } = he2(), { id: s3, inNodeContext: d3 } = ge2(), [c3] = (0, import_react2.useState)(() => {
    ...
    if (d3) {
      ...
      if (a3 && a3.data.type === r2) return a3.id;
...
var De = ({ children: e, json: t2, data: n2 }) => {
  ...
  if (!s3.current) {
    const o3 = n2 || t2;
    if (o3) r2.history.ignore().deserialize(o3);
    else if (e) {
...
var Me = function(e, t2) {
  ...
  var n2, r2 = function(e2, t3) {
    var n3 = function(e3) {
      if (Fe && Fe.resolver === e3) return Fe.reversed;
...
function Je(e, t2, n2, r2) {
  for (var o3 = { parent: e, index: 0, where: "before" }, a3 = 0, i2 = 0, s3 = 0, d3 = 0, c3 = 0, u3 = 0, l3 = 0, f3 = t2.length; l3 < f3; l3++) {
    var p3 = t2[l3];
    if (u3 = p3.top + p3.outerHeight, d3 = p3.left + p3.outerWidth / 2, c3 = p3.top + p3.outerHeight / 2, !(i2 && p3.left > i2 || s3 && c3 >= s3 || a3 && p3.left + p3.outerWidth < a3)) if (o3.index = l3, p3.inFlow) {
      if (r2 < c3) {
        o3.where = "before";
        break;
      }
      o3.where = "after";
    } else r2 < u3 && (s3 = u3), n2 < d3 ? (i2 = d3, o3.where = "before") : (a3 = d3, o3.where = "after");
  }
  return o3;
}
var We = function(e) {
...
var rt = function(e) {
  ...
  function n2() {
    var e2;
    K2(this, n2);
    for (var r2 = arguments.length, o3 = new Array(r2), a3 = 0; a3 < r2; a3++) o3[a3] = arguments[a3];
  ...
  return Z3(n2, [{ key: "onDisable", value: function() {
    ...
    return { connect: function(n3, r2) {
      ...
      if (!t3.query.node(o3).isDraggable()) return function() {
      };
      ...
      var i2 = e2.addCraftEventListener(r2, "dragstart", function(r3) {
        ...
        } else a4 = t3.query.parseReactElement(o3).toNodeTree();
...
var dt = { methods: function(e, t2) {
  return Y3(Y3({}, /* @__PURE__ */ function(e2, t3) {
    var n2 = function(t4, n3, o3) {
      if (function n4(r3, o4) {
        ...
        var a4 = r2(n3);
        if ("child" !== o3.type) a4.data.linkedNodes[o3.id] = t4.rootNodeId;
        else {
          var s3 = o3.index;
