...
export const getLookupAccountCompanyProductByProductType  = async (payload: object
) => {
    const response = await axiosClient.post(POST_API.GET_LOOKUP_ACCOUNT_COMPANY_PRODUCT_BY_PRODUCT_TYPE, payload, { withCredentials: true })
    return response;
}
