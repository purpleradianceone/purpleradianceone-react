      ...
      <div className={isSmallScreen ? "mt-1 relative" : "mt-0 relative"}>
        {isMobileNumberInput ? (
          ...
          <input
            ...
            onBlur={onBlur}
            className={readonly ?
              "input-label-custom appearance-none block w-full px-2 py-1  border bg-gray-200 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              :
