        ...
        className={
          prop.className
            ...
            : (prop.children == "Reset Password" ? "mt-6 " : "") +
              `w-full flex justify-center ${paddingClasses} cursor-not-allowed opacity-50 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${COLORS.BG_BLUE_600_COLOR} ${COLORS.HOVER_BG_BLUE_700_COLOR_HOVER} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`
        }
      >
        {prop.children}
      </button>
      ...
      <button
        ...
        className={
          prop.className
            ? prop.className
            : (prop.children == "Reset Password" ? "mt-6 " : "") +
              `w-full flex justify-center ${paddingClasses} border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${COLORS.BG_BLUE_600_COLOR} ${COLORS.HOVER_BG_BLUE_700_COLOR_HOVER} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`
        }
      >
        {prop.spinner ? (
