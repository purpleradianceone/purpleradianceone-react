...
function SearchInput (props:FormInputProps){
    ...
    const placeholderText = props.placeholder || "Search here...";
    ...
    return (
        ...
        value={props.value}
                  type="search"
                //   id={props.id}
                  className={`w-28 min-w-20 sm:w-40 md:w-56 lg:w-80 ${isSmallScreen ? 'h-6' : props.height?props.height:"h-8"} px-1 input-label-custom bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors hover:border-gray-400 ${props.id} placeholder:text-xs`}
