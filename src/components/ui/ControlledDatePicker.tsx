  ...
  return (
    <div>
      ...
      <DatePicker
        ...
        className={
          readonly
            ? "input-label-custom block w-full px-2 py-0.5 border bg-gray-100 border-gray-300 rounded-md shadow-sm"
            : "input-label-custom block w-full px-2 py-0.5 border border-gray-300 rounded-md shadow-sm"
        }
        selected={tempDate}
        dateFormat="dd-MM-yyyy"
        isClearable={isClearable}
