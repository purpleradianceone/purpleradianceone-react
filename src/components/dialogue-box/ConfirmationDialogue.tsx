...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
  ...
  icon = AlertTriangle,
  title,
  description = "Click Confirm to continue or Cancel to stay on this page.",
  ...
  cancelButtonIcon: CancelIcon = X,
  cancelButtonClassName = "",

  // Confirm Button
  confirmButtonText = "Confirm",
  confirmButtonIcon: ConfirmIcon = Check,
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          {messageDescription && (
            <div className="caption-custom">{messageDescription}</div>
          )}
        </div>
