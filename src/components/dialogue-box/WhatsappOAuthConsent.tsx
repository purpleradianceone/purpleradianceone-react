...
function WhatsappOAuthConsent() {
  ...
  const handleConfirm = () => {
    ...
    const baseUrl = POST_API.OAUTH_CONSENT_WHATSAPP_ACCOUNT
    console.log(baseUrl);
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6 animate-in fade-in zoom-in duration-200">
        ...
        <div className="mb-6">
          <h2 className="section-header-custom mb-2">Sign In With Meta - Whatsapp</h2>
          <p className="input-label-custom">
            Do you want to signin with your Facebook account for Integrating whatsapp number
          </p>
        </div>
...
export default WhatsappOAuthConsent;
