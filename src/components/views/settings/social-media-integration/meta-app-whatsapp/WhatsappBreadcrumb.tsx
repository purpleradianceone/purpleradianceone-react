...
export const WhatsappBreadCrumb = () => {
  const TABS = [
    {
      label: "Meta Whatsapp Integration",
  ...
  const basePath = ROUTES_URL.SETTING_META_APP_INTEGRATION_WHATSAPP;
        ...
        <div className="flex w-full gap-2 justify-start pl-1">
          <div className="flex items-center gap-2">
            ...
            <ComponentHeaderAndLogo
              logo={Settings}
              headerText="Setting - Meta Whatsapp Integration"
            />
