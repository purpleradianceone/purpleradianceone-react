...
function MasterTaskManagement({
    ...
    const [selectedTaskType, setselectedTaskType] =
        useState<number | undefined>(savedFilters.selectedTaskType);
    const [selectedPriority, setselectedPriority] =
        useState<number | undefined>(savedFilters.selectedPrioritytype);
    ...
    const [selectedFrequency, setselectedFrequency] = useState<number | undefined>(savedFilters.selectedFrequency);


    const handleSelectedTaskType = (
        selectedTaskType: number | undefined
    ) => {
    ...
    const handleSelectedFrequency = (
        selectedFrequency: number | undefined
    ) => {
