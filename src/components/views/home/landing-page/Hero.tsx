...
function Hero() {
  return (
    <div className="w-full pt-20 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-blue-600 text-white px-8 py-4 rounded-full hover:bg-blue-700 flex items-center justify-center w-full sm:w-auto">
              Start Free Trial <ArrowRight className="ml-2 h-5 w-5" />
            </button>
            <button className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full hover:bg-blue-50 w-full sm:w-auto">
              Schedule Demo
            </button>
          </div>
        </div>
