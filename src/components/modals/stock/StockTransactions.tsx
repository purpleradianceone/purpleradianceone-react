...
import { ClipboardPen, LucideCalendar, ReceiptText, X } from "lucide-react";
...
const StockTransactions = ({
  ...
  const getStockTrasactions = useCallback(
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="mt-2 p-1.5  items-center ">
          <h1 className="input-label-custom  mb-1 gap-1 flex items-center ">
            <ClipboardPen className="text-blue-500" size={15} /> Transaction
            Type
          </h1>
              ...
              transactionType.map((option: any) => (
                ...
                >
                  <input
                    ...
                    onChange={() => handleTransactionTypeChange(option.id)}
