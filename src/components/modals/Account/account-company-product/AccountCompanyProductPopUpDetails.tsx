  ...
  return (
    <div>
      {/* Header */}
        ...
        {/* </div> */}
        {/* <div className="grid col-span-3  w-full grid-cols-2 md:grid-cols-3 gap-1   rounded p-0.5 "> */}
          <DisplayComponent
            icon={ShoppingBag}
            title="Quantity"
            value={
        ...
        createPortal(
          <>
            <div className="fixed inset-0 z-50 bg-black bg-opacity-5   flex justify-center items-center  p-2 sm:p-2">
              <div className="bg-white w-full max-w-6xl h-auto   rounded  p-2 relative overflow-auto">
                <FormHeader
                  icon={User}
                  onClose={handleClose}
