...
import AccountProformaInvoiceManagementList from "../../../lists/AccountProformaInvoiceManagementList";
import AccountProformaInvoiceProps from "../../../../@types/account/AccountProformaInvoiceProps";

function AccountProformaInvoice({
  account,
  ...
  const getProformaInvoice = async (signal: AbortSignal) => {
    ...
    try {
      ...
      if (response.status === STATUS_CODE.OK) {
        ...
        const formattedData: AccountProformaInvoiceProps[] = responseData.map(
          (item: any) => ({
            id: item.id,
  ...
  useEffect(() => {
    ...
    getProformaInvoice(controller.signal);
    ...
    <div className="w-full">
      ...
      >
        {userHasAccessToViewAccountProformaInvoice ? (
          <AccountProformaInvoiceManagementList
...
export default AccountProformaInvoice;
