...
const LeadAssignedCompanyProducts: React.FC<LeadAssignedProductsTableProps> = ({
  ...
  return (
    <div className=" h-auto w-full overflow-auto  bg-gray-0 ">
      {/* Header row */}
      <div className=" text-sm text-[12px] md:grid grid-cols-[2fr_1fr_1fr_0.8fr_0.7fr] gap-4 font-semibold h-5 bg-gray-200 text-gray-900    px-2">
      ...
      {data.length == 0 && (
        <div className="flex w-full gap-1 h-28 bg-green50 text-xs text-gray-400 justify-center items-center ">
         <button onClick={handleAddProductToLeadButtonClick} className="border rounded-md text-white px-1 py-0.5 bg-blue-600 ">
            +Add
          </button> 
          <span>
      ...
      {data.length > 0 &&
        data.map(
          (
            ...
            <>
            {/* <div className="w-full text-xs gap-2 text-gray-600 flex justify-end">
            Add
            <button onClick={handleAddProductToLeadButtonClick} className="border rounded-md text-white px-2 flex items-center bg-blue-600 ">
            +
          </button> 
            </div> */}
              ...
              >
                ...
                userHasAccessToUpdateLead ? (
                  ...
                  <>
                    ...
                    <div
                      className="truncate text-center cursor-pointer border rounded-lg "
                      onClick={() =>
                        product.isActive && handleEditClick(product)
                      }
                    >
