...
import { useDynamicFields } from './DynamicFieldsContext'; // 👈 Your context
...
export const TemplateSettingsPanel = () => {
  ...
  const dynamicFields = useDynamicFields(); // 👈 Get dynamic fields from context
        ...
        >
          ...
          <form
            onSubmit={(e) => {
              ...
              // TODO: API Call
              console.log({ templateName, subject, description });
            }}
          >
